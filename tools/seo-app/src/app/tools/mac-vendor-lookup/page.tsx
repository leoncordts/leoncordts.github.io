...
// Compact OUI database â€” most common vendors (deduplicated)
...
const OUI: Record<string, string> = Object.fromEntries(OUI_RAW);
    ...
    <div style={S.page}>
      ...
      <nav style={S.nav}>
        <div style={{ maxWidth: "48rem", margin: "0 auto", display: "flex", alignItems: "center", gap: "0.5rem" }}>
          <a href="/tools" style={{ color: "#38bdf8", ...S.mono, fontSize: "0.8rem" }}>â† Tools</a>
      ...
      <main style={{ maxWidth: "48rem", margin: "0 auto", padding: "3rem 1.5rem" }}>
        <div style={{ marginBottom: "2.5rem", textAlign: "center" }}>
          ...
          <p style={{ color: "#94a3b8", fontSize: "1rem" }}>Hersteller anhand der MAC-Adresse identifizieren. 100% offline â€” lokale OUI-Datenbank.</p>
        </div>
        ...
        <div style={S.card}>
          ...
          <p style={{ color: "#334155", fontSize: "0.72rem", marginTop: "0.5rem", ...S.mono }}>
            Formate: 00:1A:2B:3C:4D:5E Â· 00-1A-2B-3C-4D-5E Â· 001A2B3C4D5E Â· OUI reicht (erste 6 Zeichen)
          </p>
        </div>
                ...
                <>
                  ...
                  {formatted && (
                    <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: "0.75rem", marginTop: "0.75rem" }}>
                      ...
                      <button className={`copy-btn ${copied ? "ok" : ""}`} onClick={copy}>{copied ? "âœ“" : "Kopieren"}</button>
                    </div>
                  )}
        ...
        <div style={{ ...S.card, marginTop: "1.5rem" }}>
          ...
          <p style={{ color: "#64748b", fontSize: "0.85rem", lineHeight: 1.7 }}>
            Eine MAC-Adresse (Media Access Control) ist eine eindeutige Hardware-Kennung eines NetzwerkgerÃ¤ts. Die ersten 3 Bytes (OUI) identifizieren den Hersteller â€” die letzten 3 Bytes sind gerÃ¤tespezifisch.
          </p>
